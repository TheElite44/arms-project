...
<nav class="fixed top-0 left-0 w-full z-50 bg-gray-900/80 backdrop-blur-md shadow">
  <div class="max-w-7xl mx-auto flex items-center justify-between px-4 py-2">
    ...
    <div class="flex items-center gap-3">
      ...
      <!-- Hamburger -->
      <button class="md:hidden p-2" on:click={toggleMobileMenu} aria-label="Open menu">
        <svg class="h-7 w-7 text-orange-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
