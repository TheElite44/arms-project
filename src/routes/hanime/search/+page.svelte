                ...
                >
                  <div class="relative aspect-[3/4]">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-4">
                      <h3 class="font-semibold text-white text-sm sm:text-base mb-2 line-clamp-2 group-hover:text-[#ffb3c6] transition-colors" title={hanime.title}>
                        {hanime.title}
                      </h3>
                      <div class="flex items-center justify-between">
                        <span class="bg-[#ff003c] text-white px-2 py-1 rounded-md text-xs font-bold">18+</span>
                        <span class="text-[#ffb3c6] text-xs">{hanime.duration || '--:--'}</span>
                      </div>
                    </div>
                  </div>
                </a>
